...
<template>
  <q-layout view="lHh Lpr lFf">
    <q-header flat>
      <q-toolbar>
        <q-toolbar-title>Haqqi s</q-toolbar-title>
      </q-toolbar>
    </q-header>

    <q-page-container>
      <q-page padding>
        <h6 class="q-my-xs">Input Data</h6>
        ...
        <h6 class="q-my-s">Isi Content</h6>
        <q-list bordered class="q-mt-md">
          <q-item v-for="article in articles" :key="article.id">
            ...
            <q-item-section side>
              <q-btn text-color="white" color="green" @click="edit(article)"
                >Edit</q-btn
              >
            </q-item-section>
            <q-item-section side>
              <q-btn text-color="white" color="red" @click="remove(article.id)"
                >Hapus</q-btn
              >
            </q-item-section>
          </q-item>
        ...
        <q-btn label="Muat" @click="load" color="secondary" class="q-mt-md" />
      </q-page>
    </q-page-container>
  </q-layout>
</template>
